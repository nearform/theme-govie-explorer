...
import { WcagBadge, getWcagLevel } from './WcagBadge';
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl bg-white p-6 shadow-2xl motion-safe:animate-[scaleIn_150ms_ease-out]">
        ...
        <div className="mb-3 flex items-center gap-2">
          ...
          <span className="text-xs text-nf-muted-grey">
            WCAG {level}
          </span>
        </div>
        ...
        <div className="mb-4 space-y-1 font-mono text-xs text-nf-muted-grey">
          <p>
            <span className="text-nf-deep-navy/60">bg:</span>{' '}
            {bgName.replace(/^--/, '')}
          </p>
          <p>
            <span className="text-nf-deep-navy/60">fg:</span>{' '}
            {fgName.replace(/^--/, '')}
          </p>
        </div>
